...
\]
For any $\omega$-category $\cat{C}$, the collection of natural functor $\cO(X) \to \cC$ is in bijection with that of cones under $\cO$ with apex $\cat{C}$.\anibal{Maybe there is more structure than just sets.}
