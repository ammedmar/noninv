...
\subsection{Oriented Street diagrams}

The \textit{Street $n$-dimensional semi-simplicial diagram}, or \textit{$n^\th$ Street diagram} for short, is given by
\[
\begin{tikzcd}
	\oriental_0
...
\end{tikzcd}
\]
Simplifying the description of this diagram to
\[
\begin{tikzcd}
	\oriental_0
...
\end{tikzcd}
\]
The \textit{oriented $n^\th$ Street diagram} is given by
\[
